...
\begin{exmp} 
	Let $A : \mathbb{R}^n \to \mathbb{R}^n$ such that:
	\[
	A(x) := 
	\begin{bmatrix}
	\arctan(\pi_1(x)) \\ 
	...
	J_A(x) = 
	\begin{bmatrix} 
	\frac{\partial }{\partial x_1}A_1(x) & \cdots & \frac{\partial }{\partial x_n}A_1(x) \\
	\vdots & \ddots & \vdots \\ 
	\frac{\partial }{\partial x_1}A_n(x) & \cdots & \frac{\partial }{\partial x_n}A_n(x) 
	\end{bmatrix}
	=
	\begin{bmatrix} 

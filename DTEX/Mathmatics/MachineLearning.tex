...
\section{Surjective Continuous Non-decreasing Bounded Functionals}
	...
	\end{thm}
	\newpage
	\section{A topological description of finite normed spaces.}
	...
	\begin{thm} \textbf{The first rule of induced topologies on finite subsets is:} \\
		Let $V \subset X$ where $0 < card(V) =: N < card(\mathbb{N})$ and $X$ is a Normed space. \\
		...
		\textbf{Thus the induced topology on a finite subset of a Normed space is the discrete topology. }		
	\end{thm}

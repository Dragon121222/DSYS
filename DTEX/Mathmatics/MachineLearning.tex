...
\begin{thm} \textbf{The Compliment of a Compliment of a statements is the statement} \\
	...
	$\vdash (A \Rightarrow C) \Rightarrow ( A \lor B \Rightarrow B \lor C ) $ \\
	Substitute $A$ with $\lnot A$ \\ 
	$\vdash (\lnot A \Rightarrow C) \Rightarrow (\lnot A \lor B \Rightarrow B \lor C ) $ \\
	Substitute $C$ with $A$ \\
	$\vdash (\lnot A \Rightarrow A) \Rightarrow (\lnot A \lor B \Rightarrow B \lor A ) $ \\
	Substitute $B$ with $\lnot (\lnot A)$ \\ 
	$\vdash (\lnot A \Rightarrow A) \Rightarrow (\lnot A \lor \lnot (\lnot A) \Rightarrow \lnot (\lnot A) \lor A ) $ \\
	$\vdash (\lnot \lnot  A \lor A) \Rightarrow (\lnot A \lor \lnot (\lnot A) \Rightarrow \lnot (\lnot A) \lor A ) $ \\	
	From Shakespeare's Theorem we know that: \\ 
	$\lnot A \lor \lnot (\lnot A) \Rightarrow \lnot (\lnot A) \lor A $ \\
	From Shakespeare's Theorem we  also know that: \\ 
	$\lnot (\lnot A) \lor A $ \\
	$\lnot (\lnot (\lnot A)) \lor A$ \\
...
\begin{thm} \textbf{Captain Morgan's Laws for Logic} \\ 
	...
	$\vdash \lnot(A \land B) \Leftrightarrow \lnot( \lnot( \lnot A \lor \lnot B) )$ \hfill [Def. And] \\ 
	By the previous theorem we know that: \\ 
	$\vdash \lnot( \lnot( \lnot A \lor \lnot B) ) \Leftrightarrow \lnot A \lor \lnot B$ \hfill [Double Negative Theorem] \\ 
